...
const List = () => {
  ...
  return (
    <View>
      <View>
        {datas.map((item) => (
          <TouchableOpacity key={item.id} style={styles.view} onPress={() => openModal(item)}>
            <View>
      ...
      <Nodal modalVisible={modalVisible} setModalVisible={setModalVisible} selectedItem={selectedItem} />
    </View>
  );
};
